...
namespace TKGame.PowerUps.RelatedEntities
{
    public class Shocked : Entity
    {
                        ...
                        IGraphicsComponent graphics_)
        {
            ...
            entityTexture = Art.ShockedTexture;

            entityName = "Shocked"; // name for player class
        ...
        {
            target.AddComponent(new C_Shocked_Status(Duration, TickInterval, DamagePerTick, source));
        }
