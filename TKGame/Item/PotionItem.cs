...
namespace TKGame
{
    ...
    {
        private PhysicsComponent potionItemPhysics = new PotionItem_PhysicsComponent();
        private GraphicsComponent potionItemGraphics = new PotionItem_GraphicsComponent();
