...
namespace TKGame.PowerUps.RelatedEntities
{
    public class Frozen : Entity
    {
                        ...
                        IGraphicsComponent graphics_)
        {
            ...
            entityTexture = Art.FrozenTexture;

            entityName = "Frozen"; // name for player class
        ...
        {
            target.AddComponent(new C_Frozen_Status(Duration, TickInterval, DamagePerTick, source));
        }
